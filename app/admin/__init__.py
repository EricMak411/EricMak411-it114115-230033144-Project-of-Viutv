...
def init_admin(db):
    ...
    from app.models import Video  # Import inside the function to avoid circular import
    from app import db  # Import inside the function to avoid circular import
